...
//        products.add(new Product());
//
//        //specific Mokito interraction,tell stub to return list of products
//        when(productService.listAll()).thenReturn((List) products);// need strip generics to keep Mockito happy
//
...
//        Integer id = 1;
//
//        //Tell Mokito stub to return new product for ID 1
//        when(productService.getById(id)).thenReturn(new Product());
//
